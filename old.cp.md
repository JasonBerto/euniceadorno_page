...
<section class="hero" data-animate="fade-up">
    <div class="hero-content" data-animate="fade-up" data-delay="200">
        ...
        <a href="{{ '/portfolio' | relative_url }}" class="cta-button" data-animate="scale-up" data-delay="600">View Portfolio</a>
    </div>
    <div class="hero-image" data-animate="fade-left" data-delay="800">
        <img src="{{ '/assets/images/hero/eunice_adorno_profile.jpg' | relative_url }}" 
             alt="{{ site.title }} - Professional Portrait" 
             loading="eager">
    </div>
</section>
...
<section class="featured-work" data-animate="fade-up">
    <div class="container">
        ...
        <div class="portfolio-grid" data-animate="stagger">
            ...
            <div class="portfolio-item" data-stagger-item>
        ...
        <div class="cta-section" data-animate="fade-up" data-delay="400">
            <a href="{{ '/portfolio' | relative_url }}" class="cta-button">View All Projects</a>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="contact-content">
            ...
            <div class="contact-links" data-animate="stagger">
                <a href="mailto:{{ site.email }}" class="contact-link" data-stagger-item>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                    </svg>
                    Email Me
                </a>
                <a href="https://www.instagram.com/euadorno/" target="_blank" class="contact-link" data-stagger-item>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
